...
This warning indicates that two constant values, both greater than zero, were detected as arguments to a logical-or operation that occurs in a test context. This expression is always TRUE.
